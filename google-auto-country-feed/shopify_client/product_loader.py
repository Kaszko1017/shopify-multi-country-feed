...
class ProductLoader:
    ...
    def _build_country_variants_from_bulk(self, products: Dict, variants: Dict, 
        ...
        # Target countries with inventory
        ...
        logger.info(f"Target countries: {sorted(target_countries)}")
        ...
        logger.info(f"Created {len(final_variants)} variants ({variants_with_inventory} in stock)")
    ...
    def _create_country_variant_from_bulk(self, variant_data: Dict, product_data: Dict, 
        ...
        """Create country-specific variant."""
